    ...
    <section className='mainBg'>
       ...
       <div className="container mx-auto px-4 text-center">
           <div className='pt-20 md:pt-40 lg:pt-80'>
               <h3 data-aos="zoom-in" data-aos-duration="1500" className='tour text-2xl md:text-4xl lg:text-5xl font-bold'>
                   <span className='text-[#ffd979]'>Van Lang</span> Tour
               </h3>
                 <p data-aos="zoom-in" data-aos-duration="2000" className='aboutHead'>Your Gateway to Memorable Train Journeys</p>
               <button data-aos="zoom-in" data-aos-duration="2500" className='view  my-4 px-6 py-2 bg-[#ffd979] text-black font-bold rounded-lg transition duration-300 ease-in-out transform hover:bg-[#d3ab44] hover:shadow-lg hover:scale-105'>
                  Click Here
               </button>
           </div>
       </div>
